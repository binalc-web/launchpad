...
export function SuperAdminSidebar() {
  return (
    <aside
      className="flex shrink-0 w-[280px] min-h-screen border-r border-border bg-background box-border flex flex-col justify-start items-start p-0 gap-0"
      role="navigation"
      aria-label="Super Admin navigation"
    >
      {/* Logo Wrapper */}
      <div className="flex shrink-0 grow-0 w-[280px] h-[60px] border-b border-border box-border flex flex-row justify-between items-center">
