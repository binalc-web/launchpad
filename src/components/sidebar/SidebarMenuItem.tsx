...
export function SidebarMenuItem({
  ...
  return (
    <Link
      href={to}
      className="flex shrink-0 grow-0 w-[240px] h-8 rounded-[6px] flex-row justify-start items-center py-1 px-3 gap-2 box-border hover:bg-muted/10 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
      aria-label={label}
    >
      <div className="flex min-w-0 flex-1 flex-row items-center gap-2 box-border">
        <div className="flex shrink-0 w-5 h-5 box-border relative" aria-hidden>
          <Icon
            className="w-5 h-5 text-[var(--sidebar-text)]"
            strokeWidth={1.5}
          />
        </div>
